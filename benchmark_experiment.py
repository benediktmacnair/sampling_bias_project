...
Original file is located at
    https://colab.research.google.com/drive/1GPYh3Si6kro0dLpIAifzJRW5QSfUGnGp
"""
...
labar_model.fit(
    accepts_x=final_accepts.drop(columns=["BAD"]).values,
...
# Instantiate and fit Heckman Model (FOR VENUS)



fitted_models = {
    #"Heckman-Bivariate": heckman_bivariate,     @VENUS
    #"Heckman-TwoStage": heckman_twostage,       @VENUS
    "LARAB": labar_model,
